...
class SiteConfiguration extends Model
{
    ...
    public static $messages_es = [
        ...
        'title_news.required' => 'El campo título de la sección experiencias es obligatorio.',
        'title_news.max' => 'El campo título de la sección experiencias no debe contener más de 191 caracteres.',
        'subtitle_news.required' => 'El campo subtítulo de la sección experiencias es obligatorio.',
        'subtitle_news.max' => 'El campo subtítulo de la sección experiencias no debe contener más de 191 caracteres.',
